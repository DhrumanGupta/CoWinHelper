## CoWinChecker
Uses selenium to send messages, and a HttpClient to get the data.
To configure: 
...
`PersonData`: the data for the bot to run on. A list of groups  the bot can check.
`PeronData.Name`: The name of the 
